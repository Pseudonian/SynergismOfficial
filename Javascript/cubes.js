...
const cubeUpgradeDescriptions = [null,
    ...
    () => "[2x3] For each 20 cubes opened at once, you get 1 additional blessing at random.",
    () => "[2x4] Iris shines her light on you. The effect power is now increased by +0.01 (+0.005 if >1000 blessings) per level.",
    () => "[2x5] Ares teaches you the art of war. The effect power is now increased by +0.01 (+0.0033 if >1000 blessings) per level.",
    ...
    () => "[3x3] For each 20 cubes opened at once, you get 1 additional blessing at random.",
    () => "[3x4] Plutus teaches you the Art of the Deal. The effect power is now increased by +0.01 (+0.0033 if >1000 blessings) per level.",
    () => "[3x5] Moloch lends you a hand in communicating with Ant God. The effect power is now increased by +0.01 (+0.0033 if >1000 blessings) per level.",
    ...
    () => "[3x8] Well, I think you got it? Gain +1% of particles on Reincarnation per second when not in a transcension or reincarnation challenge.",
    ...
    () => "[4x3] For each 20 cubes opened at once, you get yet another additional blessing at random.",
    () => "[4x4] Chronus overclocks the universe for your personal benefit. (Rewards the same as others)",
