...
function buyTalismanLevels(i) {
  ...
  if (player.rareFragments >= priceMult * Math.max(0, Math.floor(1 + 1 / 250 * Math.pow(player.talismanLevels[i] - 90, 3)))) {
    checkSum++
  }
  if (player.epicFragments >= priceMult * Math.max(0, Math.floor(1 + 1 / 125 * Math.pow(player.talismanLevels[i] - 120, 3)))) {
    checkSum++
  }
  if (player.legendaryFragments >= priceMult * Math.max(0, Math.floor(1 + 1 / 64 * Math.pow(player.talismanLevels[i] - 150, 3)))) {
    checkSum++
  }
  if (player.mythicalFragments >= priceMult * Math.max(0, Math.floor(1 + 1 / 128 * Math.pow(player.talismanLevels[i] - 150, 3)))) {
    checkSum++
  }
