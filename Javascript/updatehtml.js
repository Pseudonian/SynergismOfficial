...
function htmlInserts() {
  ...
  if (currentTab == "shop") {
    ...
    if (player.shopUpgrades.instantChallengeBought) {
      ...
      document.getElementById("instantchallenge").textContent = "Bought!"
    }
    if (player.shopUpgrades.antSpeedLevel == 3) {
      document.getElementById("antspeedbutton").textContent = "Maxed!"
    }
    if (player.shopUpgrades.cashGrabLevel == 7) {
    ...
    if (player.shopUpgrades.talismanBought) {
      ...
      document.getElementById("shoptalisman").textContent = "Bought!"
    }
  }
  if (currentTab == "ants") {
...
function buttoncolorchange() {
  ...
  if (player.toggles.fifteen && player.achievements[43] > 0.5) {
    document.getElementById("prestigebtn").style.backgroundColor = "green"
  }
  if (player.toggles.twentyone && player.upgrades[89] > 0.5 && (player.currentChallenge == "")) {
    document.getElementById("transcendbtn").style.backgroundColor = "green"
  }
  if (player.toggles.twentyseven && player.researches[46] > 0.5 && (player.currentChallenge == "" && player.currentChallengeRein == "")) {
    document.getElementById("reincarnatebtn").style.backgroundColor = "green"
  }
  if (player.toggles.eight && player.upgrades[88] > 0.5) {
  ...
  if (currentTab == "buildings") {
    ...
    if ((!player.toggles.one || player.upgrades[81] == 0) && player.coins.greaterThanOrEqualTo(player.firstCostCoin)) {
      document.getElementById("buycoin1").style.backgroundColor = "#555555"
    }
    if ((!player.toggles.two || player.upgrades[82] == 0) && player.coins.greaterThanOrEqualTo(player.secondCostCoin)) {
      document.getElementById("buycoin2").style.backgroundColor = "#555555"
    }
    if ((!player.toggles.three || player.upgrades[83] == 0) && player.coins.greaterThanOrEqualTo(player.thirdCostCoin)) {
      document.getElementById("buycoin3").style.backgroundColor = "#555555"
    }
    if ((!player.toggles.four || player.upgrades[84] == 0) && player.coins.greaterThanOrEqualTo(player.fourthCostCoin)) {
      document.getElementById("buycoin4").style.backgroundColor = "#555555"
    }
    if ((!player.toggles.five || player.upgrades[85] == 0) && player.coins.greaterThanOrEqualTo(player.fifthCostCoin)) {
      document.getElementById("buycoin5").style.backgroundColor = "#555555"
    }
    if ((!player.toggles.six || player.upgrades[86] == 0) && player.coins.greaterThanOrEqualTo(player.acceleratorCost)) {
      document.getElementById("buyaccelerator").style.backgroundColor = "#555555"
    }
    if ((!player.toggles.seven || player.upgrades[87] == 0) && player.coins.greaterThanOrEqualTo(player.multiplierCost)) {
      document.getElementById("buymultiplier").style.backgroundColor = "#555555"
    }
    if ((!player.toggles.eight || player.upgrades[88] == 0) && player.prestigePoints.greaterThanOrEqualTo(player.acceleratorBoostCost)) {
      document.getElementById("buyacceleratorboost").style.backgroundColor = "#555555"
    }
  ...
  if (currentTab == "prestige") {
    ...
    if ((!player.toggles.ten || player.achievements[78] == 0) && player.prestigePoints.greaterThanOrEqualTo(player.firstCostDiamonds)) {
      document.getElementById("buydiamond1").style.backgroundColor = "#555555"
    }
    if ((!player.toggles.eleven || player.achievements[85] == 0) && player.prestigePoints.greaterThanOrEqualTo(player.secondCostDiamonds)) {
      document.getElementById("buydiamond2").style.backgroundColor = "#555555"
    }
    if ((!player.toggles.twelve || player.achievements[92] == 0) && player.prestigePoints.greaterThanOrEqualTo(player.thirdCostDiamonds)) {
      document.getElementById("buydiamond3").style.backgroundColor = "#555555"
    }
    if ((!player.toggles.thirteen || player.achievements[99] == 0) && player.prestigePoints.greaterThanOrEqualTo(player.fourthCostDiamonds)) {
      document.getElementById("buydiamond4").style.backgroundColor = "#555555"
    }
    if ((!player.toggles.fourteen || player.achievements[106] == 0) && player.prestigePoints.greaterThanOrEqualTo(player.fifthCostDiamonds)) {
      document.getElementById("buydiamond5").style.backgroundColor = "#555555"
    }
    ...
    if (player.achievements[79] < 0.5 && player.prestigeShards.greaterThanOrEqualTo(Decimal.pow(10, (crystalUpgradesCost[0] + crystalUpgradeCostIncrement[0] * Math.floor(Math.pow(player.crystalUpgrades[0] + 0.5 - c, 2) / 2))))) {
      document.getElementById("buycrystalupgrade1").style.backgroundColor = "purple"
    }
    if (player.achievements[86] < 0.5 && player.prestigeShards.greaterThanOrEqualTo(Decimal.pow(10, (crystalUpgradesCost[1] + crystalUpgradeCostIncrement[1] * Math.floor(Math.pow(player.crystalUpgrades[1] + 0.5 - c, 2) / 2))))) {
      document.getElementById("buycrystalupgrade2").style.backgroundColor = "purple"
    }
    if (player.achievements[93] < 0.5 && player.prestigeShards.greaterThanOrEqualTo(Decimal.pow(10, (crystalUpgradesCost[2] + crystalUpgradeCostIncrement[2] * Math.floor(Math.pow(player.crystalUpgrades[2] + 0.5 - c, 2) / 2))))) {
      document.getElementById("buycrystalupgrade3").style.backgroundColor = "purple"
    }
    if (player.achievements[100] < 0.5 && player.prestigeShards.greaterThanOrEqualTo(Decimal.pow(10, (crystalUpgradesCost[3] + crystalUpgradeCostIncrement[3] * Math.floor(Math.pow(player.crystalUpgrades[3] + 0.5 - c, 2) / 2))))) {
      document.getElementById("buycrystalupgrade4").style.backgroundColor = "purple"
    }
    if (player.achievements[107] < 0.5 && player.prestigeShards.greaterThanOrEqualTo(Decimal.pow(10, (crystalUpgradesCost[4] + crystalUpgradeCostIncrement[4] * Math.floor(Math.pow(player.crystalUpgrades[4] + 0.5 - c, 2) / 2))))) {
      document.getElementById("buycrystalupgrade5").style.backgroundColor = "purple"
    }

    if (player.achievements[79] > 0.5) {
      document.getElementById("buycrystalupgrade1").style.backgroundColor = "green"
    }
    if (player.achievements[86] > 0.5) {
      document.getElementById("buycrystalupgrade2").style.backgroundColor = "green"
    }
    if (player.achievements[93] > 0.5) {
      document.getElementById("buycrystalupgrade3").style.backgroundColor = "green"
    }
    if (player.achievements[100] > 0.5) {
      document.getElementById("buycrystalupgrade4").style.backgroundColor = "green"
    }
    if (player.achievements[107] > 0.5) {
      document.getElementById("buycrystalupgrade5").style.backgroundColor = "green"
    }
  ...
  if (currentTab == "runes") {
    ...
    if (runescreen == "talismans") {
      ...
      if (player.researchPoints > 1e6) {
        document.getElementById("buyShard").style.backgroundColor = "purple"
      }
      if (player.researchPoints > 3e6) {
        document.getElementById("buyCommonFragment").style.backgroundColor = "purple"
      }
      if (player.researchPoints > 1e7 && player.runeshards > 100) {
        document.getElementById("buyUncommonFragment").style.backgroundColor = "purple"
      }
      if (player.researchPoints > 1e8 && player.runeshards > 1000) {
        document.getElementById("buyRareFragment").style.backgroundColor = "purple"
      }
      if (player.researchPoints > 1e9 && player.runeshards > 10000) {
        document.getElementById("buyEpicFragment").style.backgroundColor = "purple"
      }
      if (player.researchPoints > 1e10 && player.runeshards > 100000) {
        document.getElementById("buyLegendaryFragment").style.backgroundColor = "purple"
      }
      if (player.researchPoints > 1e11 && player.runeshards > 1e6) {
        document.getElementById("buyMythicalFragment").style.backgroundColor = "purple"
      }
    }
  ...
  if (currentTab == "transcension") {
    ...
    if ((!player.toggles.sixteen || player.upgrades[94] == 0) && player.transcendPoints.greaterThanOrEqualTo(player.firstCostMythos)) {
      document.getElementById("buymythos1").style.backgroundColor = "#555555"
    }
    if ((!player.toggles.seventeen || player.upgrades[95] == 0) && player.transcendPoints.greaterThanOrEqualTo(player.secondCostMythos)) {
      document.getElementById("buymythos2").style.backgroundColor = "#555555"
    }
    if ((!player.toggles.eighteen || player.upgrades[96] == 0) && player.transcendPoints.greaterThanOrEqualTo(player.thirdCostMythos)) {
      document.getElementById("buymythos3").style.backgroundColor = "#555555"
    }
    if ((!player.toggles.nineteen || player.upgrades[97] == 0) && player.transcendPoints.greaterThanOrEqualTo(player.fourthCostMythos)) {
      document.getElementById("buymythos4").style.backgroundColor = "#555555"
    }
    if ((!player.toggles.twenty || player.upgrades[98] == 0) && player.transcendPoints.greaterThanOrEqualTo(player.fifthCostMythos)) {
      document.getElementById("buymythos5").style.backgroundColor = "#555555"
    }
  ...
  if (currentTab == "reincarnation") {
    ...
    if (player.reincarnationPoints.greaterThanOrEqualTo(player.firstCostParticles)) {
      document.getElementById("buyparticles1").style.backgroundColor = "#555555"
    }
    if (player.reincarnationPoints.greaterThanOrEqualTo(player.secondCostParticles)) {
      document.getElementById("buyparticles2").style.backgroundColor = "#555555"
    }
    if (player.reincarnationPoints.greaterThanOrEqualTo(player.thirdCostParticles)) {
      document.getElementById("buyparticles3").style.backgroundColor = "#555555"
    }
    if (player.reincarnationPoints.greaterThanOrEqualTo(player.fourthCostParticles)) {
      document.getElementById("buyparticles4").style.backgroundColor = "#555555"
    }
    if (player.reincarnationPoints.greaterThanOrEqualTo(player.fifthCostParticles)) {
      document.getElementById("buyparticles5").style.backgroundColor = "#555555"
    }
  }
  ...
  if (currentTab == "ants") {
    ...
    if (player.reincarnationPoints.greaterThanOrEqualTo(player.firstCostAnts)) {
      document.getElementById("anttier1").style.backgroundColor = "white"
    }
    if (player.antPoints.greaterThanOrEqualTo(player.secondCostAnts)) {
      document.getElementById("anttier2").style.backgroundColor = "white"
    }
    if (player.antPoints.greaterThanOrEqualTo(player.thirdCostAnts)) {
      document.getElementById("anttier3").style.backgroundColor = "white"
    }
    if (player.antPoints.greaterThanOrEqualTo(player.fourthCostAnts)) {
      document.getElementById("anttier4").style.backgroundColor = "white"
    }
    if (player.antPoints.greaterThanOrEqualTo(player.fifthCostAnts)) {
      document.getElementById("anttier5").style.backgroundColor = "white"
    }
    if (player.antPoints.greaterThanOrEqualTo(player.sixthCostAnts)) {
      document.getElementById("anttier6").style.backgroundColor = "white"
    }
    if (player.antPoints.greaterThanOrEqualTo(player.seventhCostAnts)) {
      document.getElementById("anttier7").style.backgroundColor = "white"
    }
    if (player.antPoints.greaterThanOrEqualTo(player.eighthCostAnts)) {
      document.getElementById("anttier8").style.backgroundColor = "white"
    }
  }
}
