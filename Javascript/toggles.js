...
function toggleauto() {
  ...
  for (var i = 0; i < e.length; i++) {
    var a = ""
    var b = ""
    if ((i <= 7 && i >= 0) || (i <= 17 && i >= 13) || (i <= 23 && i >= 19) || (i <= 29 && i >= 25)) {
      a = "Auto ["
    }
    if (i == 12) {
      a = "Hover-to-buy ["
    ...
    if (player.toggles[cardinals[u]] == true) {
      b = "ON]"
    }
    if (player.toggles[cardinals[u]] == false) {
      b = "OFF]"
    }
