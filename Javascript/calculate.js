...
function calculateTalismanEffects() {
  ...
  for (var i = 1; i <= 5; i++) {
    if (player.talismanOne[i] == (1)) {
      ...
      talisman1Effect[i] = talismanNegativeModifier[player.talismanRarity[1]] * player.talismanLevels[1] * (-1)
    }
    ...
    if (player.talismanTwo[i] == (1)) {
      ...
      talisman2Effect[i] = talismanNegativeModifier[player.talismanRarity[2]] * player.talismanLevels[2] * (-1)
    }
    ...
    if (player.talismanThree[i] == (1)) {
      ...
      talisman3Effect[i] = talismanNegativeModifier[player.talismanRarity[3]] * player.talismanLevels[3] * (-1)
    }
    ...
    if (player.talismanFour[i] == (1)) {
      ...
      talisman4Effect[i] = talismanNegativeModifier[player.talismanRarity[4]] * player.talismanLevels[4] * (-1)
    }
    ...
    if (player.talismanFive[i] == (1)) {
      ...
      talisman5Effect[i] = talismanNegativeModifier[player.talismanRarity[5]] * player.talismanLevels[5] * (-1)
    }
    ...
    if (player.talismanSix[i] == (1)) {
      ...
      talisman6Effect[i] = talismanNegativeModifier[player.talismanRarity[6]] * player.talismanLevels[6] * (-1)
    }
    ...
    if (player.talismanSeven[i] == (1)) {
      ...
      talisman7Effect[i] = talismanNegativeModifier[player.talismanRarity[7]] * player.talismanLevels[7] * (-1)
    }
...
function calculateOffline(forceTime) {
  ...
  if (player.researches[61] > 0.5) {
    ...
    if (player.upgrades[69] > 0.5) {
      u *= Math.min(3, Decimal.pow(Decimal.log(reincarnationPointGain.add(11), 10), 0.5))
    }
