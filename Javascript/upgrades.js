...
const upgradetexts = [null,
  function() {
    return "Worker Production x" + format((totalCoinOwned + 1) * Math.min(1e30, Math.pow(1.008, totalCoinOwned)), 2)
  },
  function() {
    return "Investment Production x" + format((totalCoinOwned + 1) * Math.min(1e30, Math.pow(1.008, totalCoinOwned)), 2)
  },
  function() {
    return "Printer Production x" + format((totalCoinOwned + 1) * Math.min(1e30, Math.pow(1.008, totalCoinOwned)), 2)
  },
  function() {
    return "Mint Production x" + format((totalCoinOwned + 1) * Math.min(1e30, Math.pow(1.008, totalCoinOwned)), 2)
  },
  function() {
    return "Alchemy Production x" + format((totalCoinOwned + 1) * Math.min(1e30, Math.pow(1.008, totalCoinOwned)), 2)
  },
  function() {
    return "All Coin production x" + format((totalCoinOwned + 1) * Math.min(1e30, Math.pow(1.008, totalCoinOwned)), 2)
  },
  function() {
    return "Gain " + Math.min(4, 1 + Math.floor(Decimal.log(player.fifthOwnedCoin + 1, 10))) + " free multipliers from bought Alchemies."
  },
  function() {
    return "+" + Math.floor(player.multiplierBought / 7) + " free Accelerators."
  },
  function() {
    return "+" + Math.floor(player.acceleratorBought / 10) + " free Multipliers."
  },
  function() {
    return "Worker Production x" + format(Decimal.pow(2, Math.min(50, player.secondOwnedCoin / 15)), 2)
  },
  function() {
    return "Generator efficiency x" + format(Decimal.pow(1.02, freeAccelerator), 2)
  },
  function() {
    return "All Coin production x" + format(Decimal.min(1e4, Decimal.pow(1.01, player.prestigeCount)), 2)
  },
  function() {
    return "Investment Production x" + format(Decimal.min(1e50, Decimal.pow(player.firstGeneratedMythos.add(player.firstOwnedMythos).add(1), 4 / 3).times(1e10)), 2)
  },
  function() {
    return "Printer Generation x" + format(Decimal.pow(1.15, freeAccelerator), 2)
  },
  function() {
    return "Mint Generation x" + format(Decimal.pow(1.15, freeAccelerator), 2)
  },
  function() {
    return "Gain " + format(Decimal.pow(acceleratorEffect, 1 / 3), 2) + "x more Diamonds on prestige"
  },
  function() {
    return "Mint Production x1e100 (Duh)"
  },
  function() {
    return "Printer Prodction x" + format(Decimal.min(1e125, player.transcendShards.add(1)))
  },
  function() {
    return "Investment Production x" + format(Decimal.min(1e200, player.transcendPoints.times(1e30).add(1)))
  },
  function() {
    return "All coin production is further multiplied by " + format(Decimal.pow((totalCoinOwned + 1) * Math.min(1e30, Math.pow(1.008, totalCoinOwned)), 10), 2) + " [Stacks with upgrade 1]!"
  },
  function() {
    return "+" + format(Math.floor((1 + (1 / 101 * freeMultiplier)))) + " Multipliers, +" + format(Math.floor((5 + (1 / 101 * freeAccelerator)))) + " Accelerators."
  },
  function() {
    return "+" + format(Math.floor((1 + (1 / 101 * freeMultiplier)))) + " Multipliers, +" + format(Math.floor((4 + (1 / 101 * freeAccelerator)))) + " Accelerators."
  },
  function() {
    return "+" + format(Math.floor((1 + (1 / 101 * freeMultiplier)))) + " Multipliers, +" + format(Math.floor((3 + (1 / 101 * freeAccelerator)))) + " Accelerators."
  },
  function() {
    return "+" + format(Math.floor((1 + (1 / 101 * freeMultiplier)))) + " Multipliers, +" + format(Math.floor((2 + (1 / 101 * freeAccelerator)))) + " Accelerators."
  },
  function() {
    return "+" + format(Math.floor((1 + (1 / 101 * freeMultiplier)))) + " Multipliers, +" + format(Math.floor((1 + (1 / 101 * freeAccelerator)))) + " Accelerators."
  },
  function() {
    return "+" + format(Math.floor((1 + (1 / 41 * freeAcceleratorBoost)))) + " Accelerator Boosts."
  },
  function() {
    return "+" + format(Math.min(250, Math.floor(Decimal.log(player.coins.add(1), 1e3))) + Math.min(1750, Math.floor(Decimal.log(player.coins.add(1), 1e15)) - 50)) + " Accelerators."
  },
  function() {
    return "+" + format(Math.min(1000, Math.floor((player.firstOwnedCoin + player.secondOwnedCoin + player.thirdOwnedCoin + player.fourthOwnedCoin + player.fifthOwnedCoin) / 160))) + " Multipliers."
  },
  function() {
    return "+" + format(Math.floor(Math.min(2000, (player.firstOwnedCoin + player.secondOwnedCoin + player.thirdOwnedCoin + player.fourthOwnedCoin + player.fifthOwnedCoin) / 80))) + " Accelerators."
  },
  function() {
    return "+" + format(Math.min(75, Math.floor(Decimal.log(player.coins.add(1), 1e10))) + Math.min(925, Math.floor(Decimal.log(player.coins.add(1), 1e30)))) + " Multipliers."
  },
  function() {
    return "+" + format(Math.floor(totalCoinOwned / 2000)) + " Accelerator Boosts"
  },
  function() {
    return "+" + format(Math.min(500, Math.floor(Decimal.log(player.prestigePoints.add(1), 1e25)))) + " Accelerators"
  },
  function() {
    return "+" + format(totalAcceleratorBoost) + " Multipliers"
  },
  function() {
    return "+" + format(Math.floor(3 / 103 * freeMultiplier)) + " Multipliers"
  },
  function() {
    return "+" + format(Math.floor(2 / 102 * freeMultiplier)) + " Multipliers"
  },
  function() {
    return "All Crystal producers x" + format(Decimal.min("1e5000", Decimal.pow(player.prestigePoints, 1 / 500)), 2)
  },
  function() {
    return "All Mythos producers production x" + format(Decimal.pow(Decimal.log(player.prestigePoints.add(10), 10), 2), 2)
  },
  function() {
    return "Gain +1% per Booster that the server has, up until 20!"
  },
  function() {
    return "Gain +2% per Booster that the server has, up until 30!"
  },
  function() {
    return "Every boost after 30 increases this reward by +1%, up until 50!"
  },
  function() {
    return "Welcome to Transcension! Coin production is multiplied by " + format(Decimal.min(1e30, Decimal.pow(player.transcendPoints.add(1), 1 / 2))) + "."
  },
  function() {
    return "All mythos shard producers are going into overdrive: x" + format(Decimal.min(1e50, Decimal.pow(player.prestigePoints.add(1), 1 / 50).dividedBy(2.5).add(1)), 2) + " the production!"
  },
  function() {
    return "Multiply all coin production by " + format(Decimal.min(1e30, Decimal.pow(1.01, player.transcendCount)), 2) + "!"
  },
  function() {
    return "Multiply Mythos gained in Transcension by " + format(Decimal.min(1e6, Decimal.pow(1.01, player.transcendCount)), 2) + "!"
  },
  function() {
    return "+" + format(Math.min(2500, Math.floor(Decimal.log(player.transcendShards.add(1), 10)))) + " Accelerators!"
  },
  function() {
    return "It's kinda self-evident, ain't it?"
  },
  function() {
    return "Mythos-tier producers production x" + format(Math.pow(1.05, player.achievementPoints) * (player.achievementPoints + 1), 2)
  },
  function() {
    return "Multiply coin production by a factor of " + format(Math.pow((totalMultiplier * totalAccelerator / 1000 + 1), 8)) + "!"
  },
  function() {
    return "+" + format(Math.min(50, Math.floor(Decimal.log(player.transcendPoints.add(1), 1e10)))) + " Multipliers through magic!"
  },
  function() {
    return "It's quite obvious what the benefit is, but you must be in a challenge for it to be in use!"
  },
  function() {
    return "Mythos-tier producers production x" + format(Math.pow(totalAcceleratorBoost, 2), 2) + "!"
  },
  function() {
    return "Mythos-tier producers production x" + format(Decimal.pow(globalMythosMultiplier, 0.025), 2) + "! It's like inception, or something."
  },
  function() {
    return "Augments will produce " + format(Decimal.min("1e1250", Decimal.pow(acceleratorEffect, 1 / 125)), 2) + "x as many Mythos Shards."
  },
  function() {
    return "Wizards will produce " + format(Decimal.min("1e2000", Decimal.pow(multiplierEffect, 1 / 180)), 2) + "x as many Enchantments; what productive spirits!"
  },
  function() {
    return "Grandmasters will produce " + format((Decimal.pow("1e1000", buildingPower - 1)), 2) + "x as many Oracles!"
  },
  function() {
    return "It's quite obvious, ain't it?"
  },
  function() {
    return "Look above!"
  },
  ...
  function() {
    return "+5% Offering Recycle/+5EXP per Offerings. Duh!"
  },
  function() {
    return "Base offering amount for Reincarnations +" + Math.floor(1 / 5 * (player.challengecompletions.one + player.challengecompletions.two + player.challengecompletions.three + player.challengecompletions.four + player.challengecompletions.five + player.challengecompletions.six + player.challengecompletions.seven + player.challengecompletions.eight)) + ". Challenge yourself!"
  },
  function() {
    return "All crystal production x" + format(Decimal.min("1e6000", Decimal.pow(player.reincarnationPoints.add(1), 6)))
  },
  function() {
    return "All mythos shard production x" + format(Decimal.pow(player.reincarnationPoints.add(1), 2))
  },
  function() {
    return "5x Particle gain from Reincarnations. Duh!"
  },
  function() {
    return "It's quite clear in the description!"
  },
  function() {
    return "The first particle-tier producer is " + format(Decimal.pow(1.03, player.firstOwnedParticles + player.secondOwnedParticles + player.thirdOwnedParticles + player.fourthOwnedParticles + player.fifthOwnedParticles), 2) + "x as productive."
  },
  function() {
    return "Your compliance with tax laws provides you with " + format(Math.min(2500, Math.floor(1 / 1000 * Decimal.log(taxdivisor, 10)))) + " free Multipliers, for some reason."
  },
  function() {
    return "Cosmic Magnetics will allow you to gain " + format(Math.min(10, Decimal.pow(Decimal.log(reincarnationPointGain.add(10), 10), 0.5)), 2) + "x as much Obtainium reincarnating, x" + format(Math.min(3, Decimal.pow(Decimal.log(reincarnationPointGain.add(10), 10), 0.5)), 2) + " automation gain."
  },
  function() {
    return "Your patience will allow you to gain " + format(Math.min(4, Math.max(1, Math.pow(player.reincarnationcounter / 30, 2))) * Math.pow(Math.min(19 + player.shopUpgrades.obtainiumTimerLevel * 0.6, 1 + player.reincarnationcounter / 200), 2), 2) + "x more Obtainium on Reincarnation."
  },
  function() {
    return "Writing's on the wall. Look above!"
  },
  function() {
    return "Obtainium multiplier: x" + Math.min(50, (1 + 2 * player.challengecompletions.six + 2 * player.challengecompletions.seven + 2 * player.challengecompletions.eight + 2 * player.challengecompletions.nine + 2 * player.challengecompletions.ten))
  },
  function() {
    return "Same as Transcend upgrade 10, except you MUST be in a Reincarnation challenge in particular."
  },
  function() {
    return "Obtainium multiplier: x" + format((1 + 4 * Math.min(1, Math.pow(player.maxofferings / 100000, 0.5))), 2)
  },
  function() {
    return "Offering Multiplier: x" + format((1 + 2 * Math.min(1, Math.pow(player.maxobtainium / 30000000, 0.5))), 2)
  },
  function() {
    return "Epic 5x Ants!"
  },
  function() {
    return "Ant Speed Multiplier: x" + format((Decimal.pow(1.005 + 5 / 100000 * player.researches[96], player.firstOwnedAnts + player.secondOwnedAnts + player.thirdOwnedAnts + player.fourthOwnedAnts + player.fifthOwnedAnts + player.sixthOwnedAnts + player.seventhOwnedAnts + player.eighthOwnedAnts)), 3)
  },
  function() {
    return "Look above please lol"
  },
  function() {
    return "You will gain +10% rewards =)"
  },
  function() {
    return "Ant Elo +75 if this upgrade is purchased."
  }
].concat(
  new Array(40).fill(function() {
    return "All you need to know is right above this message!"
  })
)
...
var resdesc84 = "Does the new rune kinda suck? Power it up! +0.1% level effectiveness for SI rune per level!"
...
var resdesc86 = "Yeah, going back to basics. +1% Accelerators/Level."
var resdesc87 = "0/5 Multipliers SUCK: +1% Multipliers/Level."
